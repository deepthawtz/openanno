...
function addAT(atID) {
	...
	var ATmarkup = '<fieldset id="annotation-' + nextID + '" class="annotation"><legend>Type &#035;' + nextID + '</legend><section><label for="t-' + nextID + '-type">Type</label> <input type="text" name="t-' + nextID + '-type" class="obj_type" /></section><fieldset><legend>Attribute-Value Pairs</legend><table><thead><tr><th class="index">Index</th><th class="attribute">Attribute</th><th class="value">Value</th></tr></thead><tfoot><tr><td colspan="3"><p class="buttonContain"><a href="#" class="addAVP button">Add New Attribute-Value Pair</a></p></td></tr></tfoot><tbody><tr id="t-' + nextID + '-nvpair-1" class="nvpair"><td class="index">#1</td><td class="attribute"><input type="text" name="t-' + nextID + '-attribute-1" class="obj_attribute" /></td><td class="value"><input type="text" name="t-' + nextID + '-value-1" class="obj_value" /></td></tr></tbody></table></fieldset></fieldset>;
	$('#' + atID).after(ATmarkup);
}
